#!/bin/bash
echo "Creating backup for auth-svc..."
# Define paths
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SRC_DIR="$SCRIPT_DIR/../services/auth"
DEST_DIR="$SCRIPT_DIR/../services/auth_backup"
TAR_FILE="$SCRIPT_DIR/../docker/services/auth/image/app.tar.gz"
...
echo "Backup for auth-svc created: $TAR_FILE"
